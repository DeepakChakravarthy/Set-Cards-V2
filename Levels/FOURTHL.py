...
def dc1 ():
    ...
    size = ((140,70))
    GREEN2_D_SQUI = pygame.image.load("2 GREEN S DIA.png").convert()   #(image-2)
    GREEN2_D_SQUI = pygame.transform.scale(GREEN2_D_SQUI,(175,125))
    BLUE2_D_DIAMOND = pygame.image.load("2 BLUE D DIA.png").convert()   #(image-6)
    BLUE2_D_DIAMOND = pygame.transform.scale(BLUE2_D_DIAMOND,(175,125))
    card1_red_diamond = pygame.image.load("3 RED D DIA.png").convert() #(image-4)
    card1_red_diamond = pygame.transform.scale(card1_red_diamond, (175,125))
    card3_green_squigi = pygame.image.load("3 GREEN P SQUI.png").convert()#(image-3)
    card3_green_squigi = pygame.transform.scale(card3_green_squigi,(175,125))
    card4_blue_rect  =pygame.image.load("3 BLUE S RECT.png").convert()
    card4_blue_rect =pygame.transform.scale(card4_blue_rect,(175,125))
    card4_green_diamond =pygame.image.load("3 GREEN S DIA.png").convert()
    card4_green_diamond =pygame.transform.scale(card4_green_diamond,(175,125))
    card1_green_diamond=pygame.image.load("1 GREEN S DIA.png").convert()
    card1_green_diamond=pygame.transform.scale(card1_green_diamond,(175,125))
    card2_red_squigi=pygame.image.load("2 RED P SQUI.png").convert()
    card2_red_squigi=pygame.transform.scale(card2_red_squigi,(175,125))
    card3_red_rect=pygame.image.load("2 RED P RECT.png").convert()
    card3_red_rect=pygame.transform.scale(card3_red_rect,(175,125))
    card4_blue_diamond=pygame.image.load("3 BLUE P DIA.png").convert()
    card4_blue_diamond=pygame.transform.scale(card4_blue_diamond,(175,125))
    card2_blue_squigi = pygame.image.load("2 BLUE D SQUI.png").convert() #(image-5)
    card2_blue_squigi = pygame.transform.scale(card2_blue_squigi,(175,125))
    card1_blue_squigie = pygame.image.load("3 BLUE D SQUI.png").convert() #(image-1)
    card1_blue_squigie= pygame.transform.scale(card1_blue_squigie,(175,125))
    font = pygame.font.SysFont("comicsansms", 40)
    text = font.render("Level 4", True, (250, 80, 37))
    ...
    messagebox.showwarning("SET-CARDS","Note: Upcoming Level Click all the Sets and Finally Click Submit Button")
    while True:
        ...
        for event in pygame.event.get():
            ...
            if b.collidepoint(pos) and pressed1:
                if (c ==2 and c1 ==2 and c2 == 1 and c3 == 2 and c4 ==2 and c6 ==1 and c7==2 and c8 == 2 and c10 == 2 and c11 == 2):
        ...
        surface.blit(card4_blue_rect,card3)
        surface.blit(card1_red_diamond,card4)
